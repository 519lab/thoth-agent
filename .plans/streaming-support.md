# Streaming LLM Response Support for Thoth Agent
...
```
THOTH_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("THOTH_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `thoth_cli/config.py` | 1 | +streaming config defaults |
