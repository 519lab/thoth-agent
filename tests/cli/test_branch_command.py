...
def session_db(tmp_path, thoth_db_initialized_sync):
    ...
    """
    os.environ["THOTH_HOME"] = str(tmp_path / ".thoth")
    os.makedirs(tmp_path / ".thoth", exist_ok=True)
...
def cli_instance(tmp_path, session_db):
    """Create a minimal ThothCLI-like object for testing _handle_branch_command."""
...
class TestBranchCommandCLI:
    ...
    def test_branch_creates_new_session(self, cli_instance, session_db):
        ...
        ThothCLI._handle_branch_command(cli_instance, "/branch")
    ...
    def test_branch_with_custom_name(self, cli_instance, session_db):
        ...
        ThothCLI._handle_branch_command(cli_instance, "/branch refactor approach")
