...
The fix writes snapshots under ``~/.thoth/sessions/saved/`` and prints
...
def test_save_conversation_writes_under_thoth_home(thoth_home, tmp_path, monkeypatch, capsys):
    """Snapshot must land under ~/.thoth/sessions/saved/, not CWD."""
    ...
    # File MUST be under ~/.thoth/sessions/saved/
