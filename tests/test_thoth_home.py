...
def test_disk_default_is_always_thoth(fake_home):
    # ~/.thoth is the single canonical home — disk probing for any legacy
    # location was dropped in the de-Hermes rename.
