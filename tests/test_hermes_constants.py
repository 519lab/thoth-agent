"""Tests for thoth_constants module."""
...
class TestIsContainer:
    ...
    def _reset_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(thoth_constants, "_container_detected", None)
    ...
    def test_caches_result(self, monkeypatch):
        ...
        monkeypatch.setattr(thoth_constants, "_container_detected", True)
        assert is_container() is True
