...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from thoth_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in THOTH_OVERLAYS
        overlay = THOTH_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify thoth doctor recognizes Xiaomi env vars."""
