"""Tests for the interactive session browser (`thoth sessions browse`).
...
from thoth_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """thoth sessions browse should be parseable."""
        from thoth_cli.main import main as _main_entry
