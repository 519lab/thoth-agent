"""Tests for `thoth curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import thoth_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated THOTH_HOME with real agent-created skills on disk."""
    home = tmp_path / ".thoth"
    skills = home / "skills"
    ...
    from thoth_cli import curator as curator_cli
