"""Tests for thoth_cli.web_server and related config utilities."""
...
class TestReloadEnv:
    ...
    def test_removes_deleted_known_vars(self, tmp_path):
        """reload_env() removes known Thoth vars not present in .env."""
        env_file = tmp_path / ".env"
    ...
    def test_does_not_remove_unknown_vars(self, tmp_path):
        """reload_env() preserves non-Thoth env vars even when absent from .env."""
        env_file = tmp_path / ".env"
        env_file.write_text("")
        with patch.dict(reload_env.__globals__, {"get_env_path": lambda: env_file}):
...
class TestWebServerEndpoints:
    ...
    def _setup_test_client(self, monkeypatch, _isolate_thoth_home):
        """Create a TestClient and isolate the state DB under the test THOTH_HOME."""
        try:
    ...
    def test_get_status_filters_unconfigured_gateway_platforms(self, monkeypatch):
        ...
        import thoth_cli.web_server as web_server
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from thoth_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_bad_token(self, tmp_path):
        ...
        from thoth_cli.config import save_env_value
        from thoth_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from thoth_cli.config import save_env_value
        from thoth_cli.web_server import _SESSION_TOKEN
    ...
    def test_path_traversal_dotdot_blocked(self):
        ...
        resp = self.client.get("/%2e%2e/thoth_cli/web_server.py")
        assert resp.status_code in {200, 404}
        if resp.status_code == 200:
...
class TestBuildSchemaFromConfig:
    def test_produces_expected_field_count(self):
        from thoth_cli.web_server import CONFIG_SCHEMA
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from thoth_cli.web_server import _build_schema_from_config
...
class TestNewEndpoints:
    ...
    def test_profile_setup_command_uses_named_profile_wrapper(self):
        ...
        (get_thoth_home() / "profiles" / "coder").mkdir(parents=True)
    ...
    def test_profile_setup_command_uses_thoth_for_default_profile(self):
        ...
        assert resp.status_code == 200
        assert resp.json()["command"] == "thoth setup"
    ...
    def test_profiles_create_with_clone_from_default_copies_default_skills(self, monkeypatch):
        ...
        default_skill = get_thoth_home() / "skills" / "custom" / "new-skill"
        ...
        assert resp.status_code == 200
        cloned_skill = get_thoth_home() / "profiles" / "cloned" / "skills" / "custom" / "new-skill" / "SKILL.md"
    ...
    def test_profiles_create_without_clone_seeds_bundled_skills(self, monkeypatch):
        ...
        assert resp.status_code == 200
        seeded_skill = get_thoth_home() / "profiles" / "fresh" / "skills" / "software-development" / "plan" / "SKILL.md"
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        ...
        import thoth_cli.skills_config as skills_config
        import thoth_cli.web_server as web_server
    ...
    def test_toolsets_list_matches_cli_enabled_state(self, monkeypatch):
        import thoth_cli.tools_config as tools_config
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from thoth_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from thoth_cli.web_server import _denormalize_config_from_web
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from thoth_cli.web_server import _normalise_theme_definition
...
class TestDiscoverUserThemes:
    ...
    def test_returns_empty_when_dir_missing(self, tmp_path, monkeypatch):
        ...
        from thoth_cli import web_server
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from thoth_cli.pty_bridge import PtyUnavailableError
