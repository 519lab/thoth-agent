...
The main() function in thoth_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `thoth -c model`
...
def _build_parser():
    """Build a minimal replica of the thoth top-level parser."""
