...
def test_import_loads_env_from_thoth_home(tmp_path, monkeypatch):
    home = tmp_path / ".thoth"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-thoth-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-thoth-home"
