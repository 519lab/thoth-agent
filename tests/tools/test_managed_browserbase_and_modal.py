...
def _enable_managed_nous_tools(monkeypatch):
    ...
    thoth_cli.auth and thoth_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("thoth_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("thoth_cli.models.check_nous_free_tier", lambda: False)
