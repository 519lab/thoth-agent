"""Tests for the secret-source tracking in ``thoth_cli.env_loader``.

These cover the small public surface that lets `thoth model` / `thoth setup`
...
from thoth_cli import env_loader  # noqa: E402
