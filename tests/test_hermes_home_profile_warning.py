"""Tests for get_thoth_home() profile-mode fallback warning.

Regression test for https://github.com/519lab/thoth-agent/issues/18594.
...
def fresh_constants(monkeypatch, tmp_path):
    """Import thoth_constants fresh and reset the one-shot warn flag."""
    import importlib
...
class TestGetThothHomeProfileWarning:
    ...
    def test_named_profile_unset_home_warns_once(
        ...
        fresh_constants.get_thoth_home()
        fresh_constants.get_thoth_home()
        err2 = capsys.readouterr().err
        assert "THOTH_HOME fallback" not in err2
