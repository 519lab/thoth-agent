...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "thoth_approve_once" in action_ids
        assert "thoth_approve_session" in action_ids
        assert "thoth_approve_always" in action_ids
        assert "thoth_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "thoth_deny", "value": "session-key"}
