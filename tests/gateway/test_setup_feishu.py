"""Tests for _setup_feishu() in thoth_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("thoth_cli.gateway.save_env_value", side_effect=mock_save), \
         patch("thoth_cli.gateway.get_env_value", side_effect=mock_get), \
         patch("thoth_cli.gateway.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("thoth_cli.gateway.prompt_choice", side_effect=prompt_choice_responses), \
         patch("thoth_cli.gateway.prompt", side_effect=prompt_responses), \
         patch("thoth_cli.gateway.print_info"), \
         patch("thoth_cli.gateway.print_success"), \
         patch("thoth_cli.gateway.print_warning"), \
         patch("thoth_cli.gateway.print_error"), \
         patch("thoth_cli.gateway.color", side_effect=lambda t, c: t), \
         patch("gateway.platforms.feishu.qr_register", return_value=qr_result):

        from thoth_cli.gateway import _setup_feishu
        _setup_feishu()
