...
Invoked by ``thoth kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Thoth Agent board.
...
def _profile_author() -> str:
    """Mirror of ``thoth_cli.kanban._profile_author``."""
    return (
