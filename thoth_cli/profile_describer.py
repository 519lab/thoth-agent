...
Used by ``thoth profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Thoth Agent kanban board.
...
Rules:
  ...
  - Never write "Thoth Agent profile" or other meta-narration.
