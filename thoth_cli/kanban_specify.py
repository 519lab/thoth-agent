...
Used by ``thoth kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``thoth_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Thoth Agent board.
