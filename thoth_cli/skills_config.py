"""
Skills configuration for Thoth Agent.
`thoth skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.thoth/config.yaml under:
...
from thoth_cli.config import cfg_get, load_config, save_config
from thoth_cli.colors import Colors, color
from thoth_cli.platforms import PLATFORMS as _PLATFORMS
