...
def _sanitize_subprocess_env(base_env: dict | None, extra_env: dict | None = None) -> dict:
    """Filter Thoth-managed secrets from a subprocess environment."""
    try:
...
def _make_run_env(env: dict) -> dict:
    ...
    # Thoth is driving via _find_bash (Git Bash), and Git Bash itself
...
def _resolve_shell_init_files() -> list[str]:
    ...
    an explicit list — once they have, Thoth trusts them.
    """
