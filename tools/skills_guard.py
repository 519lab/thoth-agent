...
Trust levels:
  - builtin:   Ships with Thoth. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.thoth/\.env|\~/\.thoth/\.env',
     "thoth_env_access", "critical", "exfiltration",
     "directly references Thoth secrets file"),
    ...
    (r'\.thoth/config\.yaml|\.thoth/SOUL\.md',
     "thoth_config_mod", "critical", "persistence",
     "references Thoth configuration files directly"),
