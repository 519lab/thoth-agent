...
`mcp_tool.py`, and `thoth_cli/mcp_config.py`. This module is the ONLY place
...
def _make_thoth_provider_class() -> Optional[type]:
    ...
    class ThothMCPOAuthProvider(OAuthClientProvider):
        ...
        def __init__(self, *args: Any, server_name: str = "", **kwargs: Any):
            ...
            self._thoth_server_name = server_name
                ...
                for url in build_protected_resource_metadata_discovery_urls(
                    ...
                    try:
                        ...
                        logger.debug(
                            ...
                            self._thoth_server_name, url, exc,
                        )
                        continue
                ...
                for url in build_oauth_authorization_server_metadata_discovery_urls(
                    ...
                    if asm:
                        ...
                        logger.debug(
                            ...
                            "token_endpoint=%s",
                            self._thoth_server_name, asm.token_endpoint,
                        )
                        break
...
class MCPOAuthManager:
    ...
    def remove(self, server_name: str) -> None:
        ...
        Called by ``thoth mcp remove <name>`` and (indirectly) by
        ``thoth mcp login <name>`` during forced re-auth.
        """
        with self._entries_lock:
