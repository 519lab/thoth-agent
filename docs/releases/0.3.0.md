...
- **Remaining hardcoded `~/.hermes` paths** — all now respect `THOTH_HOME` (Issue [#892](https://github.com/NousResearch/hermes-agent/issues/892), [#1233](https://github.com/NousResearch/hermes-agent/pull/1233))
