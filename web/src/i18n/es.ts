...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateThoth: "Actualizar Thoth",
    updatingThoth: "Actualizando Thoth…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Thoth (equivalente a `thoth plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.thoth/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.thoth/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.thoth/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Thoth Achievements",
      subtitle:
        "Insignias coleccionables de Thoth ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de Thoth. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa Thoth más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que Thoth detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "Thoth está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Thoth Agent ☤",
    },
  },
  kanban: {
