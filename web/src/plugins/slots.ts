 ...
 * `window.__THOTH_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Thoth brand in the top bar
 ...
 *  `window.__THOTH_PLUGINS__.registerSlot(...)`.
 *
