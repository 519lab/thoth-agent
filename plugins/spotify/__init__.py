...
``_check_spotify_available()`` — when the user has not run ``thoth auth
spotify``, the tools remain registered (so they appear in ``thoth
...
The Spotify auth flow (``thoth auth spotify``), CLI plumbing, and docs
