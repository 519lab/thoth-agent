...
class HonchoSessionManager:
    ...
    Runs alongside thoth' existing SQLite state and file-based memory,
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Apply Thoth-side char cap before caching
    ...
    def get_prefetch_context(self, session_key: str, user_message: str | None = None) -> dict[str, str]:
        ...
        # Also fetch AI peer's own representation so Thoth knows itself.
        try:
    ...
    def migrate_memory_files(self, session_key: str, memory_dir: str) -> bool:
        ...
        Args:
            ...
            memory_dir: Path to the memories directory (~/.thoth/memories/).
