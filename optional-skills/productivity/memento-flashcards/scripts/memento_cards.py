...
Data file: $THOTH_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_THOTH_HOME = Path(os.environ.get("THOTH_HOME", Path.home() / ".thoth"))
DATA_DIR = _THOTH_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
