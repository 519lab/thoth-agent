#!/usr/bin/env python3
"""
SWE Runner with Thoth Trajectory Format

A runner that uses Thoth-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Thoth-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Thoth-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Thoth format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Thoth-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Thoth-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Thoth Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Thoth-Agent's built-in execution environments
    and outputs trajectories in Thoth-Agent format.
    """
    ...
    def _convert_to_thoth_format(
        ...
        """
        Convert internal message format to Thoth trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Thoth trajectory format
        trajectory = self._convert_to_thoth_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Thoth trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Thoth Trajectory Format")
    print("=" * 60)
