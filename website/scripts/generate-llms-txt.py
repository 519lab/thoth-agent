#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Thoth docs site.
...
Both publish at:
  https://thoth.519lab.com/docs/llms.txt
  https://thoth.519lab.com/docs/llms-full.txt
...
SITE_BASE = "https://thoth.519lab.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Thoth as a Python Library", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Thoth"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/519lab/"
        "thoth-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/519lab/thoth-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Thoth Agent — Full Documentation\n",
        (
            "This file is the entire Thoth Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Thoth, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://thoth.519lab.com/docs\n",
        "Short index: https://thoth.519lab.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
