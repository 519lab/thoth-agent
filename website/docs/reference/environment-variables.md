...
| `THOTH_TUI_DIR` | Path to a prebuilt `ui-tui/` directory (must contain `dist/entry.js` and populated `node_modules`). Used by distros and system packages to skip the first-launch `npm install`. |
