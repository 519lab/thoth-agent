...
You are Thoth, an AI assistant created by Nous Research.
...
```
You are Thoth Agent, an intelligent AI assistant created by Nous Research.
...
|----------|-------|-------------|-------|
| 1 | `.hermes.md`, `HERMES.md` | CWD up to git root | Thoth-native project config |
