...
[PR #12550](https://github.com/519lab/thoth-agent/pull/12550) proposed a
...
One `asyncio.Task` running in a background daemon thread per Thoth `task_id`.
...
- `thoth_cli/config.py` — add `browser.dialog_policy` and `browser.dialog_timeout_s` to `DEFAULT_CONFIG`
