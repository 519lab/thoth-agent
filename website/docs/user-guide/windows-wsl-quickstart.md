...
- **[MCP guide → WSL → Windows Chrome](/docs/guides/use-mcp-with-thoth#wsl2-bridge-thoth-in-wsl-to-windows-chrome)** — controlling your signed-in Windows Chrome from Thoth in WSL.
