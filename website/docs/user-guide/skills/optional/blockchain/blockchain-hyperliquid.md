...
| | |
|---|---|
| Source | Optional — install with `thoth skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Thoth Agent |
| License | MIT |
...
The script reads `~/.thoth/.env` for two optional defaults:
...
Helper script: `~/.thoth/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.thoth/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.thoth/.env`.
...
```bash
python3 ~/.thoth/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.thoth/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
