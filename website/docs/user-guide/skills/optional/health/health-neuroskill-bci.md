...
| | |
|---|---|
| Source | Optional — install with `thoth skills install official/health/neuroskill-bci` |
...
Connect Thoth to a running [NeuroSkill](https://neuroskill.com/) instance to read
