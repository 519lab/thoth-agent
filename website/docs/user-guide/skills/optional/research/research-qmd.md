...
| | |
|---|---|
| Source | Optional — install with `thoth skills install official/research/qmd` |
...
Thoth Agent via the native MCP client. This is the preferred
...
Then configure Thoth Agent to connect via HTTP:
