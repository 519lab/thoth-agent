...
| | |
|---|---|
| Source | Optional — install with `thoth skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Thoth Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $THOTH_OSINT_CACHE/icij/ (default: ~/.cache/hermes-osint/icij/).
...
# Set THOTH_OSINT_UA=your-app/1.0 (your@email) to identify yourself
