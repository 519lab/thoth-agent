...
| | |
|---|---|
| Source | Optional — install with `thoth skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Thoth Agent |
| License | MIT |
...
```
SCRIPT=~/.thoth/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.thoth/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
