...
| | |
|---|---|
| Source | Optional — install with `thoth skills install official/finance/3-statement-model` |
...
See [references/formulas.md](https://github.com/519lab/thoth-agent/blob/main/optional-skills/finance/3-statement-model/references/formulas.md) for all formula details.
