...
| | |
|---|---|
| Source | Optional — install with `thoth skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Thoth","productType":"Apparel","tags":["test"]}}'
```
