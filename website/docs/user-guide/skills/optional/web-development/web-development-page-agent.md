...
- User wants **Thoth itself to drive a browser** → use Thoth' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
