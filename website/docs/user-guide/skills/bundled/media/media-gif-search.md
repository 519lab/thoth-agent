...
Set your Tenor API key in your environment (add to `~/.thoth/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/519lab/thoth-agent/blob/main/skills/media/gif-search/url)`
