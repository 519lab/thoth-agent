...
```bash
python3 -m pyfiglet "THOTH" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=THOTH&font=Slant" | boxes -d stone
```
