...
| Google Gemini (OAuth) | `google-gemini-cli` | `thoth model` (Google OAuth; optional: `THOTH_GEMINI_PROJECT_ID`) |
...
| Qwen Portal (OAuth) | `qwen-oauth` | `thoth model` (Qwen Portal OAuth; optional: `THOTH_QWEN_BASE_URL`) |
