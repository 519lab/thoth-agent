...
- **[Context Files](context-files.md)** — Thoth automatically discovers and loads project context files (`.thoth.md`, `AGENTS.md`, `CLAUDE.md`, `SOUL.md`, `.cursorrules`) that shape how it behaves in your project.
