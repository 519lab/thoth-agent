...
description: "Customize Thoth Agent's personality with a global SOUL.md, built-in personalities, and custom persona definitions"
---
...
- how Thoth should handle uncertainty, disagreement, or ambiguity
...
## What Thoth injects into the prompt
...
Thoth ships with built-in personalities you can switch to with `/personality`.
...
| **pirate** | Captain Thoth, tech-savvy buccaneer |
...
These are convenient overlays, but your global `SOUL.md` still gives Thoth its persistent default personality unless the overlay meaningfully changes it.
...
- [SOUL.md Guide](/docs/guides/use-soul-with-thoth)

## CLI appearance vs conversational personality

Conversational personality and CLI appearance are separate:

- `SOUL.md`, `agent.system_prompt`, and `/personality` affect how Thoth speaks
- `display.skin` and `/skin` affect how Thoth looks in the terminal
