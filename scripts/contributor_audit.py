...
Usage:
    ...
    python scripts/contributor_audit.py --since-tag v2026.4.8 --release-file docs/releases/0.9.0.md
"""
...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^(Thoth|Hermes)\s+(Agent|Audit)$", re.IGNORECASE),
