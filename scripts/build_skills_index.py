#!/usr/bin/env python3
"""Build the Thoth Skills Index — a centralized JSON catalog of all skills.
...
`thoth skills search/install` can use it without hitting the GitHub API.
...
# Ensure THOTH_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Thoth Skills Index...", flush=True)
