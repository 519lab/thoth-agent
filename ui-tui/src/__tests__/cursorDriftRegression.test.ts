 ...
 *
 * Symptom: in `thoth --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@thoth/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using thoth --tui and as i type multiline my caret at the end will often ' +
