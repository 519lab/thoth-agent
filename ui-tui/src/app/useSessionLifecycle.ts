...
import type { ScrollBoxHandle } from '@thoth/ink'
import { evictInkCaches } from '@thoth/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.THOTH_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
