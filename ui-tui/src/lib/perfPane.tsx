...
//
// Both gate on THOTH_DEV_PERF=1 and dump JSON-lines (default ~/.thoth/perf.log,
...
const LOG_PATH = process.env.THOTH_DEV_PERF_LOG?.trim() || join(homedir(), '.thoth', 'perf.log')
