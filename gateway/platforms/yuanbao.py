...
try:
    ...
    _THOTH_VERSION = "0.0.0"

_APP_VERSION = _THOTH_VERSION
_BOT_VERSION = _THOTH_VERSION
_YUANBAO_INSTANCE_ID = str(THOTH_INSTANCE_ID)  # single source: yuanbao_proto.THOTH_INSTANCE_ID
