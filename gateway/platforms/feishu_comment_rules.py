...
Config: ~/.thoth/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.thoth/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_thoth_home()`` helper (THOTH_HOME-aware and
...
RULES_FILE = get_thoth_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_thoth_home() / "feishu_comment_pairing.json"
