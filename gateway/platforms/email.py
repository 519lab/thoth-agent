"""
Email platform adapter for the Thoth gateway.

Allows users to interact with Thoth by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Thoth Agent")
        ...
        msg_id = f"<thoth-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
