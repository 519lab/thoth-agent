...
Built for [Thoth Agent](https://github.com/519lab/thoth-agent). Usable in any coding agent. Canonical source lives here; synced to [`519lab/thoth-agent/skills/creative/ascii-video`](https://github.com/519lab/thoth-agent/tree/main/skills/creative/ascii-video) via PR.
