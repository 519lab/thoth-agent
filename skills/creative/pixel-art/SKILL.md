...
```python
import sys
sys.path.insert(0, "/home/teknium/.thoth/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.thoth/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Thoth installs package this)
