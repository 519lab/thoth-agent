...
description: Use when a Thoth Kanban worker wants to run Codex CLI as an isolated implementation lane while Thoth keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Thoth Agent
license: MIT
metadata:
