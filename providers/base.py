...
def _profile_user_agent() -> str:
    """Return a ``thoth-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from thoth_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"thoth-cli/{_ver}"
    except Exception:
        return "thoth-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # thoth-cli UA so the catalog endpoint is reachable.
